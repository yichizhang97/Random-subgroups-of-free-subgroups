"""
Monte Carlo Simulation of Random Subgroups of Free Groups

This script generates random subgroups of free groups under user-specified
parameters and runs Monte Carlo trials to study their statistical properties.
It collects and analyzes invariants of the generated subgroups to provide
insight into typical behaviors and distributions relevant to geometric group
theory.
"""
